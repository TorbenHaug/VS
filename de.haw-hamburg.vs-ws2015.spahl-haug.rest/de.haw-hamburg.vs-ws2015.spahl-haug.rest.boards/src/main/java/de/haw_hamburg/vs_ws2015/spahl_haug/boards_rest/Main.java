...
public class Main {
	...
	@ResponseStatus(HttpStatus.OK)
	public Player getPlayerPostion(@PathVariable(value="gameid") final long gameID, @PathVariable(value="playerid") final long playerID) throws GameDoesntExistsException, PlayerDoesntExistsException {
		if (isGameIdValid(gameID)) {
